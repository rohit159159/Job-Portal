const fields=[
    ...
    {label:"Location",placeholder:"Enter Job Location", options:['Delhi', 'Pune','Banglore','Maharastra','Gurugram','Hariyana','Bihar','Odissa','Goa','Mumbai','Hyderabad', 'New York', 'San Francisco', 'London', 'Berlin', 'Tokyo', 'Sydney', 'Toronto']},
